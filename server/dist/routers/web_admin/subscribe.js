...
var subscribeBlogService_1 = require("../../service/web_admin/subscribeBlogService");
...
router.get('/list', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, subscribeBlogService_1.subscribeService(req.query)];
            case 1:
                result = _a.sent();
...
router.delete('/delete', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, subscribeBlogService_1.deSubService(req.body)];
            case 1:
                result = _a.sent();
                res.writeHead(200, { 'Content-Type': enum_1.ResponseState.ContentType });
