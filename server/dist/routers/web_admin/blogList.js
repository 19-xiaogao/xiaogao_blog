...
var blogService_1 = require("../../service/web_admin/blogService");
var router = express_1.default.Router();
// 创建博客
router.post("/insert_blog", function (req, res) {
    blogService_1.insertBlog(req.body, function (result) {
...
router.post('/update_blog', function (req, res) {
    res.writeHead(200, { 'Content-Type': enum_1.ResponseState.ContentType });
    blogService_1.updateBlog(req.body, function (result) {
...
router.delete('/delete', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, blogService_1.deleteBlog(req.body)];
            case 2:
                _a.sent();
                res.write(result_1.writeResult({ success: true, message: enum_1.ResponseState.success, data: '' }));
                res.end();
            ...
            case 3:
                error_1 = _a.sent();
                res.write(result_1.writeResult({ success: false, message: enum_1.ResponseState.failed, data: error_1 }));
                res.send();
                return [3 /*break*/, 4];
...
router.get('/all', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, blogService_1.getAllBlogService()];
            case 2:
                result = _a.sent();
                res.write(result_1.writeResult({ success: true, message: enum_1.ResponseState.success, data: result }));
                res.end();
