...
var comment_1 = require("../../service/web_admin/comment");
var router = express_1.default.Router();
// 获取评论列表
router.get('/list', function (req, res) {
    comment_1.selectComment(req.query, function (result) {
...
router.delete('/delete', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, comment_1.deleteComment(req.body)];
            case 1:
                result = _a.sent();
                res.writeHead(200, { 'Content-Type': enum_1.ResponseState.ContentType });
...
// 修改是否显示
router.post('/shielding', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, comment_1.shieldingComment(req.body)];
            case 1:
                result = _a.sent();
                res.writeHead(200, { 'Content-Type': enum_1.ResponseState.ContentType });
                res.write(result_1.writeResult({ success: true, message: enum_1.ResponseState.success, data: '' }));
