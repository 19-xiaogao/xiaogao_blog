...
var emailService_1 = require("../../service/common/emailService");
...
router.post('/sendEmail', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, emailService_1.sendEmailSubscribe()];
            case 2:
                result = _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                res.write(result_1.writeResult({ success: false, message: enum_1.ResponseState.failed, data: '' }));
                res.end();
                return [3 /*break*/, 4];
